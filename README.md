...
> **Note:** This repository contains the frontend of MeTTa Rift. If you're looking for the backend, visit [MeTTa Rift – Backend](https://github.com/philipesantos/metta-rift-backend).
...
- [**MeTTa Rift – Backend**](https://github.com/philipesantos/metta-rift-backend) (Currently not available on Windows)

### Installation

```sh
# Clone the repository
git clone https://github.com/philipesantos/metta-rift-frontend.git
cd metta-rift-frontend
